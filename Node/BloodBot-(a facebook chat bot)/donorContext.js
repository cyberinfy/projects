...
module.exports.donor = function (aiText, sender, temp, tmp) {
    if (aiText === "Dear donor you are successfully unsubscribed.") {
    ...
    if (aiText === "can you please mention your gender?(M/F/Other)") {
        var data = {
            id: sender
        }
   ...
   return vsend(sender,aiText);
    ...
    if (aiText === 'Thank you for your social concern, we will inform you if we need your service. If you want to delete your details please enter "unsubscribe me"') {
     obj.find({
            "email": sender
        }, (err, data) => {
            if (err) {
